<?php
$aksi="pages/page_profil/aksi_profil.php";

$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from guru where nip=$_SESSION[id_pengguna]");
...
<div class="widget-content">
    <form  method=POST enctype='multipart/form-data' action="<?php echo $aksi;?>?pages=profil&act=update" class="form uniformForm validateForm">
