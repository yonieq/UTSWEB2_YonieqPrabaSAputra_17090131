...
<div class="widget-content">
    <form  method=POST enctype='multipart/form-data' action="<?php echo $aksi; ?>?pages=foto&act=update" class="form uniformForm validateForm">
        <div class="field-group">
            <label for="required">Foto Sekarang :</label>
            <div class="field">
                <div class="pp">
                    <img alt="" src="<?php echo $data_sidebar['foto_guru']; ?>">
                </div>
            </div>
        </div> <!-- .field-group -->
